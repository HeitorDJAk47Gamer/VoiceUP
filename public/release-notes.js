(() => {
  ...
  const version = String(window.voiceupVersion || '1.1.0');
  ...
  const copy = {
    'pt-BR': {
      eyebrow: 'VERSÃO {version}', title: 'Novidades desta versão', subtitle: 'Esta atualização reúne a nova experiência visual e todos os recursos preparados para o próximo lançamento.', close: 'Entendi', reopen: 'Novidades da {version}', auto: 'Salvamento automático',
    ...
    'en-US': {
      eyebrow: 'VERSION {version}', title: 'What is new in this version', subtitle: 'This update combines the new visual experience and every feature prepared for the next release.', close: 'Got it', reopen: 'What is new in {version}', auto: 'Autosave on',
    ...
    'es-ES': {
      eyebrow: 'VERSIÓN {version}', title: 'Novedades de esta versión', subtitle: 'Esta actualización reúne la nueva experiencia visual y todas las funciones del próximo lanzamiento.', close: 'Entendido', reopen: 'Novedades de {version}', auto: 'Guardado automático',
    ...
    'fr-FR': {
      eyebrow: 'VERSION {version}', title: 'Nouveautés de cette version', subtitle: 'Cette mise à jour réunit la nouvelle expérience visuelle et toutes les fonctions de la prochaine version.', close: 'Compris', reopen: 'Nouveautés de {version}', auto: 'Enregistrement auto',
  ...
  copy['pt-BR'].notes.push('Compatibilidade — O microfone atual volta a usar a faixa original em 100% e é preparado antes da negociação, corrigindo áudio atual → Client antigo.');
  ...
  copy['es-ES'].notes.push('Compatibilidad — Al 100% la beta publica la pista original del micrófono y la prepara antes de negociar, corrigiendo el audio hacia Clients antiguos.');
